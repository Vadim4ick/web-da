    ...
    >
      <Container>
        <div className="bg-primary-blue max-mobile:flex-col max-mobile:gap-6 max-mobile:py-8 max-mobile:px-2 flex h-full justify-between rounded-[20px]">
          ...
          <div className="max-tablet:py-6 max-mobile:mt-2 max-tablet:px-4 max-mobile:mx-0 max-mobile:rounded-[12px] max-mobile:max-w-full max-tablet:mr-[20px] max-tablet:max-w-[344px] max-tablet:gap-6 mr-[40px] flex w-full max-w-[506px] flex-col gap-8 bg-white px-[36px] py-[60px]">
            ...
            <div className="max-tablet:gap-1.5 flex flex-col gap-2">
              <Input label="Имя" type="text" placeholder="Олежанов Евгений" />
              <Input
                label="Телефон"
                type="tel"
            ...
            <p className="tablet:hidden font-manrope text-additional-grey-60 text-center text-[12px] leading-[15px] font-semibold">
              Отправляя данную форму вы соглашаетесь <br /> с политикой
              конфиденциальности
            </p>

            <Button className="max-tablet:h-[46px] max-tablet:text-[14px] max-tablet:leading-[18px] h-[60px] rounded-[100px] text-[16px] leading-[125%] font-bold">
              Обсудить проект
            </Button>
          </div>
